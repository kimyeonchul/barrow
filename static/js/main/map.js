...
function geoFindMe() {
  ...
  gido(staticlat,staticlon);
}
// document.querySelector('#find-me').addEventListener('click', geoFindMe);
$(document).ready(function () {
  geoFindMe();
});
if(staticlat === 0 && staticlon === 0){
        geoFindMe();
    }

function gido(staticlat, staticlon) {
  ...
  function resizeMap() {
    ...
    mapContainer.style.height = '840px';
  }
  function relayout() {
...
const pageCount = Math.ceil(near_item_num / 4);
